		...
		try{
			Class.forName("com.mysql.jdbc.Driver");  
		 	Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3307/digitaltunes","root","root"); 
				...
				if(ie>0)
			    {
					out.println("<html><body background=ban.GIF bgcolor=chocalate text=BLUE                  vlink=red link=blue><center><h2><br><br>The Cd's are added successfully<br>Want to add another CDs <a href=addcds.html>Go Back</a><br>Home Page<a href=administration.html>Go</a> ");
