...
String s1=request.getParameter("film").trim();
...
else if(s2.equalsIgnoreCase("price"))
{%>
<jsp:include page="price.html" />
<%
}
else if(s2.equalsIgnoreCase("cat"))
{%>
<jsp:forward page="cat.html" />
<%
}
else if(s2.equalsIgnoreCase("singer"))
{%>
